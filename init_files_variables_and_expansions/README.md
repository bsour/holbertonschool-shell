...
16. Write a script that prints every other line from the input, starting with 
the first line.

17(18). Write a shell script that adds the two numbers stored in the environment
